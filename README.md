...
## Gameplay:
  ...
  - Then, click on another card to try to find its matching pair.
  - If the symbols on the two cards match, they will remain face-up.
  - If the symbols don't match, both cards will flip back over.
  - Keep flipping pairs of cards until you find all the matching pairs.
## Rules:
